...
\begin{figure}[H]%
    \centering
    \includegraphics[width=4cm]{docs/entwurf/Entwurf_dokument/img/klassenView/Menu.png}
...
\begin{figure}[H]%
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/FileMenu.png}
        \caption{Die Klasse \classref{FileMenu}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=6cm]{docs/entwurf/Entwurf_dokument/img/Alissa/EditMenuGUI.png} %Aus versehen anders benannt. Sollte eig. FileMenuGUI heißen
...
\begin{figure}[H]%
    ...
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=6cm]{docs/entwurf/Entwurf_dokument/img/Alissa/FileMenuGUI.png} %Aus versehen anders benannt. Sollte eig. EditMenuGUI heißen
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/FileManagementWindow.png}
...
\begin{figure}[H]%
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/ColumnWidget.png}
        \caption{Die Klasse \classref{ColumnWidget}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/Alissa/Columns.png} 
...
\begin{figure}[H]%
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/EvaluationWidget.png}
        \caption{Die Klasse \classref{EvaluationWidget}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/Alissa/evaluationGUI.png} 
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/ThresholdWindow.png}
...
\begin{figure}[H]%
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/ProcessingWidget.png}
        \caption{Die Klasse \classref{ProcessingWidget}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/Alissa/Processing.png} 
...
\begin{figure}[H]%
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/klassenView/ModelWidget.png}
        \caption{Die Klasse \classref{ModelWidget}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/Alissa/ModelGUI.png} 
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/cls/model/Data.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=10cm]{docs/entwurf/Entwurf_dokument/img/cls/model/FunctionalExpression.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=7cm]{docs/entwurf/Entwurf_dokument/img/cls/model/GroupMap.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=7cm]{docs/entwurf/Entwurf_dokument/img/cls/model/ErrorReport.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/cls/model/StringMarker.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{docs/entwurf/Entwurf_dokument/img/cls/model/ProcessingConfig.png}
    \caption{Klassendiagramm \classref{ProcessingConfig}}
\end{figure}

Die Klasse definiert, auf welche Art und Weise eine Datenverarbeitung eines Datenmodells erfolgt. Sie bietet einen Ansatz für zukünftige Erweiterungen hinsichtlich weiterer Verarbeitungsarten.
\\\\
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/cls/model/ProcessingConfigs.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=6cm]{docs/entwurf/Entwurf_dokument/img/cls/model/Evaluation.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{docs/entwurf/Entwurf_dokument/img/cls/model/Optimizer.png}
    \caption{Klassendiagramm von \classref{Optimizer}}
\end{figure}

Das Interface bietet eine Schnittstelle zur Implementierung eines beliebigen Optimierungsalgorithmus. Es bietet einen Ansatzpunkt für zukünftige Erweiterungen hinsichtlich verschiedener Optimierungsverfahren.
\\\\
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{docs/entwurf/Entwurf_dokument/img/cls/model/Project.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{docs/entwurf/Entwurf_dokument/img/cls/model/ProjectSnapshot.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/cls/model/ProxyProject.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{docs/entwurf/Entwurf_dokument/img/cls/model/Threshold.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=10cm]{docs/entwurf/Floriane/FunctionController.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=10cm]{docs/entwurf/Floriane/DerivativeController.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=10cm]{docs/entwurf/Floriane/ConfigurationController.png}
...
\begin{enumerate}
    \item[1.] Befehl \texttt{do\char`_operation(op)} erreicht \texttt{pp:\classref{ProxyProject}}.
    \item[2.] Kopie des Projektzustands wird angestoßen.
    \item[3.] Kopie des Projektzustands wird angelegt (\texttt{cp:\classref{ProjectSnapshot}}).
    \item[4.] Kopie wird an \classref{ProxyProject} zurückgegeben.
    ...
    \begin{enumerate}
        ...
        \item[9.] Wenn die Operation erfolgreich verlaufen ist, wird abschließend noch im \classref{ProxyProject} (\emph{pp}) der neue Projektzustand (\emph{cp}) als aktueller Zustand hinterlegt.
        \item[11.] Das Projekt wird nach der erfolgreichen Operation (sofern möglich) gespeichert.
    \end{enumerate}
    \item[] Wenn die Operation fehlgeschlagen ist:
    \begin{enumerate}
        \item[13.] Kopie des Projektzustands wird gelöscht.
    \end{enumerate}
    \item[14.] Zurückgeben, ob Operation erfolgreich.
\end{enumerate}

\paragraph{Neues Projekt öffnen}\mbox{}
\begin{figure}[H]%
    \includegraphics[width=15cm]{docs/entwurf/Entwurf_dokument/img/Alissa/SQOpenNewProject3.png}
...
\begin{enumerate}
    ...
    \guibutton{Open New Project} im Dateimenü.
    \item[1.5] Der Nutzer wählt über dem Datei-Dialog den Speicherort.  
    \item[2.] Die Funktion \texttt{open\char`_new\char`_project(path)} in der Klasse \classref{FileMenu} wird aufgerufen. Als Parameter \textit{path} wird der gewählte Speicherort als String übergeben.
    \item[3.] In der Funktion \texttt{open\char`_new\char`_project(path)} wird der Controller (hier: \classref{ProjectManager}) durch \texttt{open(path)} aufgerufen.
    \item[4.] Durch den Controller wird ein \classref{ProxyProject} Objekt erstellt.
    \item[5.] Das \classref{ProxyProject} Objekt erstellt automatisch (Durch Aufrufen seines Konstruktors) einen Objekt vom Typ \textit{Project}
    \item[6.] Das \classref{Project}\textendash Objekt erstellt zwei Objekte. Zuerst vom Typ \classref{Data}. Dieses wird bei Erstellung des Objekts vom Typ \classref{Model} benötigt. 
\end{enumerate}

Somit wird ein neues Projekt geöffnet.
\begin{figure}[H]%
    \includegraphics[width=15cm]{docs/entwurf/Entwurf_dokument/img/Alissa/SQImportDataFinal.png}
...
\begin{enumerate}
    \item[1.] Der Nutzer klickt auf die Schaltfläche \guibutton{Import Data} im \classref{FileMenu} und wählt durch den Datei Dialog die zu importierende CSV-Datei. Dadurch wird die Funktion \texttt{import\char`_data(path)} im \classref{FileMenu} aufgerufen.
    \item[2.] Dieses ruft den \classref{ProjectManager}, in dem die Methode \texttt{import()} aufgerufen wird.
    \item[3.] In der Methode \texttt{import()} wird die CSV Datei geöffnet. Nun stehen die Daten als \textit{data} vom Typ \textit{pandas.DataFrame}.
    \item[4.] Die Daten werden an das \classref{ProxyProject} übergeben, dieses ordnet dem \classref{Project}\textendash Objekt die Daten \textit{data} zu.
    \item[5.] Das \classref{Project}\textendash Objekt leitet die Daten an das \classref{Model} weiter, und diese werden dann an \classref{Data} weitergeleitet. Das ermöglicht es, die Daten zu verwalten.
    \item[6.] Als letzter Schritt muss noch das \classref{FileMenu} das \classref{MainWindow} informieren, damit dieses die importierten Daten anzeigt. 
\end{enumerate}
\newpage
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Alissa/SaveProjectAD.png}
...
\begin{enumerate}
    \item[1.] Der Nutzer klickt auf \guibutton{Save Project}, welches im Dateimenü zu finden ist.
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Alissa/SaveProjectAsAD.png}
    \caption{Aktivitätsdiagramm für Projekt Speichern Unter}
    \label{ADProkjektSpeichernAls}
\end{figure}
Dafür kann der Nutzer die Option \guibutton{Save Project As} im Dateimenü wählen. Der Ablauf ist der Option \guibutton{Save project} (vgl. Abb. \ref{ADProjekt Speichern}) sehr ähnlich, nur hier kann der Nutzer einen Speicherort im Datei\textendash Dialog wählen.
\\\\
\paragraph{CSV-Datei exportieren}\mbox{}
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Alissa/ExportCSVAD.png}
...
\begin{enumerate}
    \item[1.] Der Nutzer klickt auf \guibutton{Export Data} im Dateimenü.
...
Da einige Funktionen vergleichbar zu denen aus dem Attributsmanagement sind (vgl. Abschnitt ~\ref{sec:Änderung einer Attributsableitung}), werden hier Referenzen angegeben. Die Unterschiede bestehen darin, dass \textit{alternative} anstatt \textit{derivative} genutzt wird und die Klasse \classref{Data} nicht benötigt wird. Änderungen werden direkt in der Klasse \classref{Model} durchgeführt.

\subsubsection{Änderung einer Alternative}
\label{sec:ChangeAlternative}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=12cm]{docs/entwurf/Entwurf_dokument/img/Kevin/ChangeAlternative.png}
...
Das Löschen einer Alternative verläuft sehr ähnlich wie das Ändern einer Alternative. Eine genauere Beschreibung befindet sich bereits beim Löschen einer Attributsableitung (vgl. Abschnitt~\ref{sec:ChangeAlternative}).
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=12cm]{docs/entwurf/Entwurf_dokument/img/Kevin/ExportAlternative.png}
    \caption{Sequenzdiagramm zum Export einer Alternative}
    \label{fig:sd:ExportAlternative}
\end{figure}

Zuerst wählt der Nutzer eine Alternative aus und drückt auf den Button \guibutton{Export} (Schritt 1). \\
Daraufhin wird ein neues \classref{FileManagementWindow} geöffnet (Schritt 2). \\
Dieses lässt den Nutzer den Dateipfad für die erstellte Datei wählen (Schritt 3, 4). \\
Das \classref{ModelWidget} ruft im zugewiesenen \classref{AlternativeController} die Funktion \texttt{export(path)} auf (Schritt 6). \\
Nun ruft der \classref{AlternativeController} über den \textit{Projektmanager} das \classref{ProxyProject} auf (Schritt 7, 8). \\
Über den aktuellen ProjectSnapshot wird die Alternative über den Namen (label) aus dem \classref{Model} geladen, zurückgeschickt und zum angegebenen Dateipfad exportiert (Schritt 9 -- 15).
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Michael/sd_change_processing_config.png}
...
\begin{enumerate}
    ...
    \item[3.] Von dort aus wird der dafür zuständige \classref{ConfigurationController} beauftragt, die Änderung ins \classref{Model} zu übertragen.
...
\label{sec:CalculateEvaluation}
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Damian/Berechnung durchführen.png}
    \caption{Sequenzdiagramm zur Ausführung der Evaluation}
    \label{fig:sd:CalculateEvaluation}
\end{figure}

Für die Evaluierung muss mindestens eine Alternative im Projekt hinterlegt worden sein (siehe Abschnitt \ref{sec:ChangeAlternative}).\\
\begin{enumerate}
    \item [1. -- 2.] Zum Starten der Berechnung drückt der Nutzer auf den Button \\ \guibutton{Calculate Evaluation}. Daraufhin wird die entsprechende Methode in dem \classref{EvaluationWidget} gestartet.
    ...
    \item [11. -- 12.] Das Fenster ermöglicht zudem über den Button \guibutton{Abort} eine Möglichkeit die Berechnung abzubrechen (\texttt{alt: [abort]}). Daraufhin wird der laufende \texttt{Thread} terminiert und das neue Fenster geschlossen.
    ...
    \item [18.] Anschließend wird ein \texttt{update()}-Aufruf gestartet (siehe Abschnitt \ref{sec:EvaluationWidgetUpdate}). Damit werden die neuen Ergebnisse in das \classref{EvaluationWidget} geladen und angezeigt. \\
...
\label{sec:EvaluationWidgetUpdate}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Damian/EvaluationWidget.update().png}
    \caption{Sequenzdiagramm zur Ausführung der Evaluation}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Michael/sd_optimize_model.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Damian/Ergebnisse exportieren.png}
...
Nach Berechnung der Evaluation (siehe Abschnitt \ref{sec:CalculateEvaluation}) können den Spalten vom Nutzer Schwellwerte zugeteilt werden. Diese haben eine Auswirkung auf die farbliche Visualisierung der Ergebnistabelle.
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/Damian/Schwellwerte konfigurieren.png}
    \caption{Sequenzdiagramm zur Konfigurierung der Schwellwerte}
    \label{fig:sd:ChangeThresholds}
\end{figure}

\begin{enumerate}
    \item [1.] Nachdem die Berechnungen ausgeführt wurden und dargestellt sind, kann der Nutzer auf den Button \guibutton{View Options} drücken.
    ...
    \item [13. -- 24.] Änderungen sollen gemeinsam in einem neuen \classref{ProjectSnapshot} gespeichert werden. Beim Aufruf sperrt das Fenster dem Nutzer also den Zugriff auf den Rest der Anwendung, damit es gesichert zu keinen Synchronitätsfehlern kommen kann. \\ Änderungen können über einen Button \guibutton{Cancel} rückgängig gemacht werden und das Fenster wird geschlossen. Nach Anwendung der Änderung über den Button \guibutton{Apply} werden die neuen Schwellwerte in einem neuen \classref{ProjectSnapshot} hinterlegt. 
    \item [25.] Das \classref{EvaluationWidget} lädt die Visualisierung daraufhin neu (siehe Abschnitt~\ref{sec:EvaluationWidgetUpdate}).
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=13cm]{docs/entwurf/Entwurf_dokument/img/KlassendiagrammAlles.png}
