...
class DerivativeController(FunctionController):
    ...
    def get_derivatives(self) -> dict[str, FunctionalExpression]:
        ...
        Returns:
            dict[str, FunctionalExpression]: all derivatives, with their respective label as key and their functional expression object as value.
        """
        return self.get_project().get_derivatives()


    def add(self, label: str, function: str):
        # TODO: functional expression ist hier auch str. Man gibt doch keine fertige funktion ein?
    ...
    def change(self, label: str, function: str):
        """ The changing of the function of a derivative in the model. The function to be changed is defined through its label. 
    ...
    def validate(self, function: str) -> FunctionalExpression:
        """ The safety validation of a function that is supposed to be a derivative.

        Args:
            function (str): user input for the functional expression.

        Returns:
            FunctionalExpression: the functionalExpression object that contains the function if there are no safety concerns, else None.
        """
