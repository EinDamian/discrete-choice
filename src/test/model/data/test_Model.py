...
class TestInterval(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ('error_missing_dependency_dataframe', {'col': [1, 2]}, {'a': FunctionalExpression('12.5')},
         {'car': Alternative(FunctionalExpression('(a / col) + var'), FunctionalExpression("col"), 0)},
         {'var': 3.2}, 'car',
         ErrorReport(False, {StringMarker(Config.ERROR_VARIABLE_NON_EXISTENT.format('col'), 0, 3, Config.COLOR_HEX)})),
        ('error_missing_dependency_derivative', {'col': [1, 2]}, {'a': FunctionalExpression('12.5')},
         {'car': Alternative(FunctionalExpression('(a / col) + var'), FunctionalExpression("a"), 0)},
         {'var': 3.2}, 'car',
