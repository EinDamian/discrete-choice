...
Über den aktuellen ProjectSnapshot wird die Alternative über den Namen (label) aus dem Model geladen, zurückgeschickt und zum angegebenen Dateipfad exportiert (Schritt 9 -- 15).
