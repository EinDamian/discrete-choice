...
\begin{enumerate}
    ...
    \item[3.] Kopie des Projektzustands wird angelegt (\textt{cp:ProjectSnapshot})
...
\begin{enumerate}
    ...
    \item[3.] Ansonsten erscheint eine Fehler Meldung un der Vorgang wird abgeborechen.
\end{enumerate}
...
\\\\
AbbXY1: Change Derivative Diagramm
\\\\
