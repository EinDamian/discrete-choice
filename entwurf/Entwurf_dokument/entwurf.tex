...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{entwurf/Entwurf_dokument/img/cls/model/ProcessingConfig.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=6cm]{entwurf/Entwurf_dokument/img/cls/model/Evaluation.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{entwurf/Entwurf_dokument/img/cls/model/Optimizer.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{entwurf/Entwurf_dokument/img/cls/model/Project.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=8cm]{entwurf/Entwurf_dokument/img/cls/model/ProjectSnapshot.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{entwurf/Entwurf_dokument/img/cls/model/ProxyProject.png}
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=5cm]{entwurf/Entwurf_dokument/img/cls/model/Threshold.png}
