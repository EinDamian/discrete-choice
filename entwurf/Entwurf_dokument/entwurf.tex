...
\begin{tabular}{lll}
 & \texttt{KeyError} & Bezeichner der Alternative ist ungültig.\\
\end{tabular}
...
Die Validierung einer Alternativen ist wieder vergleichbar zur ValidiAttributsableitungen

\subsection{Update einer Alternative}
Vergleichbar zu Attributsableitungen
