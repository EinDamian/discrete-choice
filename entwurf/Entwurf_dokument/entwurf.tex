...
Darstellung eines definierbaren Intervalls bei Festlegung der Attributsableitung. Wird bei der Evaluation erzeugt und kann ausgewertet werden.
\newline \newline
...
\item \texttt{include\char`_begin: bool} \newline Intervall inkludiert 
\item \texttt{include\char`_end: bool} \newline Inkludieren des Endes des Intervalls.
\\\\
\end{itemize}
