...
\textbf{Produktfunktion} & \textbf{/F10/} \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T20/}         & \textbf{Exportieren der CSV-Datei (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/F13/} \\
\textbf{Vorbedingung}  & Die CSV-Datei ist im Programm geladen. \\ & Alle Attributsableitungen sind valide. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T21/}         & \textbf{Exportieren der CSV-Datei (Teilerfolg)} \\
\textbf{Produktfunktion} & \textbf{/F13/} \\
\textbf{Vorbedingung}  & Die CSV-Datei ist im Programm geladen. \\ & Es existieren invalide Attributsableitungen. \\
\textbf{Beschreibung}  & Der Nutzer exportiert die CSV-Datei. \\ & Das Programm meldet invalide Attributsableitungen. \\ & Der Nutzer führt den Export fort. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T22/}         & \textbf{Exportieren der CSV-Datei (Abbruch)} \\
\textbf{Produktfunktion} & \textbf{/F13/} \\
\textbf{Vorbedingung}  & Die CSV-Datei ist im Programm geladen. \\ & Es existieren invalide Attributsableitungen. \\
\textbf{Beschreibung}  & Der Nutzer exportiert die CSV-Datei. \\ & Das Programm meldet invalide Attributsableitungen. \\ & Der Nutzer bricht den Export ab. \\
...
\textbf{Produktfunktion} & \textbf{/F11/} \\
\textbf{Vorbedingung}  & Das Programm ist gestartet.   \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T31/}         & \textbf{Projekt speichern (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/F12/} \\
\textbf{Vorbedingung}  & Das Projekt ist geöffnet.   \\ & Alle Eingaben sind valide. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T32/}         & \textbf{Projekt speichern (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/F12/} \\
\textbf{Vorbedingung}  & Das Projekt ist geöffnet.   \\ & Es existieren invalide Eingaben. \\
\textbf{Beschreibung}  & Der Nutzer speichert das Projekt. \\ & Das Programm meldet invalide Eingaben. \\ & Der Nutzer führt das Speichern fort. \\
\textbf{Nachbedingung} & Das Projekt wurde gespeichert.
\end{tabularx}
\end{table}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T33/}         & \textbf{Projekt speichern (Abbruch)} \\
\textbf{Produktfunktion} & \textbf{/F12/} \\
\textbf{Vorbedingung}  & Das Projekt ist geöffnet.   \\ & Es existieren invalide Eingaben. \\
\textbf{Beschreibung}  & Der Nutzer speichert das Projekt. \\ & Das Programm meldet invalide Eingaben. \\ & Der Nutzer bricht das Speichern ab. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T40/}         & \textbf{Attributsableitung hinzufügen (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/F15/} \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T41/}         & \textbf{Attributsableitung hinzufügen (Misserfolg)} \\
\textbf{Produktfunktion} & \textbf{/15/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen.   \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T42/}         & \textbf{Attributsableitung ändern (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/16/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Attributsableitung.  \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T43/}         & \textbf{Attributsableitung ändern (Misserfolg)} \\
\textbf{Produktfunktion} & \textbf{/16/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Attributsableitung.   \\
\textbf{Beschreibung}  & Der Nutzer wählt eine Attributsableitung aus, gibt eine valide Attributsableitung ein und wendet die Änderung an. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T44/}         & \textbf{Attributsableitung löschen (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/17/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Attributsableitung.  \\ & Andere Eingaben haben eine Abhängigkeit zu der ausgewählten Attributsableitung. \\
...
\textbf{Produktfunktion} & \textbf{/17/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Attributsableitung.  \\ & Andere Eingaben haben eine Abhängigkeit zu der ausgewählten Attributsableitung. \\
\textbf{Beschreibung}  & Der Nutzer wählt eine Attributsableitung aus und löscht sie. \\ & Das Programm meldet eine Abhängigkeit zu dieser Ableitung. \\ & Der Nutzer führt das Löschen fort. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T44/}         & \textbf{Attributsableitung löschen (Abbruch)} \\
\textbf{Produktfunktion} & \textbf{/17/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Attributsableitung.  \\ & Andere Eingaben haben eine Abhängigkeit zu der ausgewählten Attrbiutsableitung. \\
\textbf{Beschreibung}  & Der Nutzer wählt eine Attributsableitung aus und löscht sie. \\ & Das Programm meldet eine Abhängigkeit zu dieser Ableitung. \\ & Der Nutzer bricht den Löschvorgang ab. \\
\textbf{Nachbedingung} & Der Zustand des Programms bleibt unverändert.
\end{tabularx}
\end{table}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T50/}         & \textbf{Alternative hinzufügen (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/20/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen.   \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T51/}         & \textbf{Alternative hinzufügen (Misserfolg)} \\
\textbf{Produktfunktion} & \textbf{/20/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen.   \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T52/}         & \textbf{Alternative ändern (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/21/} \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T53/}         & \textbf{Alternative ändern (Misserfolg)} \\
\textbf{Produktfunktion} & \textbf{/21/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. Es existiert mindestens eine Alternative.   \\
...
\textbf{Produktfunktion} & \textbf{/22/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. Es existiert mindestens eine Alternative.  \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T60/}         & \textbf{Berechnung durchführen (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/25/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Alternative. \\ & Alle Alternativen sind valide. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T61/}         & \textbf{Berechnung durchführen (Erfolg)} \\
\textbf{Produktfunktion} & \textbf{/25/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Alternative. \\ & Es existieren invalide Alternativen. \\
\textbf{Beschreibung}  & Der Nutzer führt die Berechnung durch. \\ & Das Programm meldet invalide Alternativen. \\ & Der Nutzer führt die Berechnung fort. \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T62/}         & \textbf{Berechnung durchführen (Abbruch)} \\
\textbf{Produktfunktion} & \textbf{/25/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Alternative. \\ & Es existieren invalide Alternativen. \\
\textbf{Beschreibung}  & Der Nutzer führt die Berechnung durch. \\ & Das Programm meldet invalide Alternativen. \\ & Der Nutzer bricht die Berechnung ab. \\
\textbf{Nachbedingung} & Der Zustand des Programms bleibt unverändert.
\end{tabularx}
\end{table}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T63/}         & \textbf{Berechnung durchführen (Abbruch)} \\
\textbf{Produktfunktion} & \textbf{/25/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde vollständig geladen. \\ & Es existiert mindestens eine Alternative. \\
\textbf{Beschreibung}  & Der Nutzer führt die Berechnung durch. \\ & Der Nutzer bricht die Berechnung mittendrin ab. \\
\textbf{Nachbedingung} & Der Zustand des Programms bleibt unverändert.
\end{tabularx}
\end{table}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T25/}         & \textbf{Exportieren der Ergebnisse}  \\
\textbf{Produktfunktion} & \textbf{/F28/} \\
\textbf{Vorbedingung}  & Die CSV-Datei ist im Programm geladen. \\ & Die Berechnungen sind abgeschlossen.   \\
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{rX}
\textbf{/T70/}         & \textbf{Änderung der Schwellwerte} \\
\textbf{Produktfunktion} & \textbf{/F30/} \\
\textbf{Vorbedingung}  & Die CSV-Datei wurde geladen. \\ & Die Berechnungen sind abgeschlossen. \\ & Die Visualisierung der Ergebnisse wird angezeigt.\\
