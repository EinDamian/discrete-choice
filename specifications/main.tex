...
\underline {Ziel}:  Ein neues Projekt öffnen, in dem eine bereits existierende CSV Datei geladen wird, welche die nötigen Erhebungsdaten beinhaltet.\\
...
\underline{Ziel}: Bereits eingegebene Attributsableitungen, Nutzenfunktionen, Ergebnisse aus schon durchgeführten Berechnungen und Änderungen an dem CSV Datei in eine Projektdatei speichern; Original CSV Datei mit Erhebungsdaten wird nicht überschrieben. \\
...
\underline{Ziel}: Die neue Tabelle (ursprüngliche Tabelle(Erhebungsdaten) mit neuen Spalten) in einer neuen CSV Datei speichern\\
\underline{Vorbedingung}: Projekt muss geöffnet sein. \\
...
\underline{Ziel}: Neue Attributsableitungen definieren. Diese werden automatisch angewendet. \\
\underline{Vorbedingung}: Projekt muss geöffnet sein. \\
\underline{Beschreibung}: Nutzer gibt Funktion an. Wenn die Eingabe syntaktisch korrekt ist, wird sie hinzugefügt und angewendet.\\
...
\underline{Beschreibung}: Nutzer gibt die Nutzenfunktion ein. Wenn die eingegebene Nutzenfunktion gültig ist (Gültig im Sinne von /MK4/ und /WK4/), wird sie hinzugefügt. Alternative wird durch diese Nutzenfunktion definiert und bekommt einen Namen. \\
